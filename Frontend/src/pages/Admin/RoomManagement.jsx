...
const RoomManagement = () => {
  ...
  return (
    <section className="relative min-h-screen overflow-hidden bg-gradient-to-b from-slate-50 via-teal-50/40 to-slate-100/90 p-4 sm:p-6 lg:p-10">
      <div
        className="pointer-events-none absolute inset-0 opacity-[0.35]"
        aria-hidden
        style={{
          backgroundImage:
            'radial-gradient(circle at 20% 10%, rgba(20, 184, 166, 0.12) 0%, transparent 45%), radial-gradient(circle at 80% 0%, rgba(15, 118, 110, 0.08) 0%, transparent 40%)'
        }}
      />
      ...
      <div className="relative mx-auto max-w-7xl">
        <div className="mb-8 flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:gap-5">
            <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-teal-600 to-teal-800 text-white shadow-lg shadow-teal-900/20">
              <svg className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  d="M2.25 21h19.5m-18-18v18m10.5-18v18m6-13.5V21M6.75 6.75h.008v.008H6.75V6.75zm0 3h.008v.008H6.75V9.75zm0 3h.008v.008H6.75v-.008zm0 3h.008v.008H6.75v-.008zm0 3h.008v.008H6.75v-.008zm3.75-9h.008v.008H10.5V6.75zm0 3h.008v.008H10.5V9.75zm0 3h.008v.008H10.5v-.008zm0 3h.008v.008H10.5v-.008zm0 3h.008v.008H10.5v-.008zm3.75-9h.008v.008H14.25V6.75zm0 3h.008v.008H14.25V9.75zm0 3h.008v.008H14.25v-.008zm0 3h.008v.008H14.25v-.008zm0 3h.008v.008H14.25v-.008zm3.75-9h.008v.008H18V6.75zm0 3h.008v.008H18V9.75zm0 3h.008v.008H18v-.008zm0 3h.008v.008H18v-.008zm0 3h.008v.008H18v-.008z"
                />
              </svg>
            </div>
            <div>
              <div className="flex flex-wrap items-center gap-2">
                <h1 className="text-3xl font-extrabold tracking-tight text-slate-900 sm:text-4xl">
                  Room <span className="bg-gradient-to-r from-teal-600 to-teal-500 bg-clip-text text-transparent">Allocation</span>
                </h1>
              ...
              <p className="mt-2 max-w-xl text-base text-slate-600">
                Manage inventory, review booking requests, and keep room status up to date in one place.
              </p>
            </div>
          </div>
