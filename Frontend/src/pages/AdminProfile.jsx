    ...
    <div className="min-h-screen flex bg-slate-50 font-sans">
      ...
      <div className="w-64 bg-white border-r border-slate-200 flex flex-col hidden md:flex h-screen sticky top-0 py-6 px-4 shadow-sm z-10">
        ...
        <div className="flex-1 space-y-2">
          ...
          <div onClick={() => navigate('/room-allocation')} className="flex items-center space-x-3 px-4 py-3 hover:bg-slate-50 text-black rounded-lg cursor-pointer transition-colors font-medium">
            <Home size={20} />
