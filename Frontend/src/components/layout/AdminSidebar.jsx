...
export default function AdminSidebar({ activeKey, onLogout, unreadNotifications = 0 }) {
            ...
            >
              ...
              <span className="flex items-center gap-2">
                ...
                {item.key === 'notifications' && unreadNotifications > 0 && (
                  <span className={`inline-flex h-5 min-w-5 items-center justify-center rounded-full px-1 text-[10px] font-bold ${active ? 'bg-white text-orange-700' : 'bg-red-500 text-white'}`}>
